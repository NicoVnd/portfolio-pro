...
Ce CDD m'a permis de renforcer ma polyvalence technique et de collaborer étroitement avec les équipes marketing et webdesign pour garantir la conformité des projets aux attentes des clients.`,
  ...
  learned: [
    "Développement multi-CMS (WordPress, PrestaShop, Webflow)",
    "Intégration de maquettes graphiques",
    "Création d'extensions WordPress sur mesure",
    "Maintenance et sécurisation de sites",
    "Collaboration en agence web",
    "Diversité des secteurs clients",
  ],
  features: [
    "Potion Magic — Site vitrine pour une agence événementielle",
    "Delebat — Site vitrine pour une entreprise de rénovation & bâtiment",
    "Isyblock — Site produit pour une solution de maintien de poubelles",
    "Ramery Mobilité Électrique — Site vitrine pour des bornes de recharge",
    "Newtech Fermetures — Site vitrine pour des portails & carports sur-mesure",
  ],
  github: "",
  demo: null,
  image: "/projects/Potion Magic.png",
  gallery: [
    "/projects/Delebat.jpg",
    "/projects/Isyblock.jpg",
    "/projects/Ramery Mobilité électrique.png",
    "/projects/Newtech.jpg",
  ],
  galleryLabels: [
    "Potion Magic",
    "Delebat",
    "Isyblock",
    "Ramery Mobilité Électrique",
    "Newtech Fermetures",
  ],
  siteLinks: [
    "https://www.potion-magic.com/",
    "https://www.delebat.fr/",
    "https://isyblock.fr/",
    "https://mobiliteelectrique.ramery.fr/",
