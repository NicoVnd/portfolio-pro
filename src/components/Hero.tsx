      ...
      <div className="container mx-auto px-4 md:px-8 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            >
              ...
              <div className="p-4 bg-white dark:bg-gray-900/90 rounded-2xl border border-[#E5E7EB] dark:border-gray-800 shadow-[rgba(15,23,42,0.06)] hover:shadow-md hover:border-[#CBD5E1] transition-all duration-200">
                ...
                <div className="font-bold text-lg text-[#1F2937] dark:text-white leading-tight">3+ ans</div>
          ...
          <div className="lg:col-span-5 relative flex justify-center items-center mt-12 lg:mt-0">
            <div className="relative w-full max-w-[360px] sm:max-w-[390px] py-4">
              ...
              <div 
                className="absolute bottom-2 -left-4 sm:-left-6 bg-[#1F2937]/95 dark:bg-gray-900/95 text-white backdrop-blur-md px-3.5 py-2 rounded-xl border border-gray-700/50 shadow-xl flex items-center gap-2.5 animate-fadeInUp z-30"
              ...
              <div 
                className="absolute top-12 -right-14 sm:-right-20 lg:-right-24 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md p-3.5 rounded-2xl border border-[#E5E7EB] dark:border-gray-800 shadow-xl shadow-slate-900/10 w-48 sm:w-52 animate-fadeInUp z-30 hover:-translate-y-1 transition-transform duration-300"
