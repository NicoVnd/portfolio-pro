    ...
    <>
      ...
      >
        <div className="container mx-auto px-4 md:px-6 flex justify-between items-center">
          ...
          <a
            href="#"
            className="group relative flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-xl bg-[#334155] p-[1.5px] shadow-sm group-hover:scale-105 transition-all duration-300"
          ...
          >
            <div className="flex items-center justify-center w-full h-full bg-white dark:bg-gray-950 rounded-[10.5px] transition-colors duration-300">
              <span className="font-black text-[#334155] dark:text-white text-base md:text-lg tracking-tight group-hover:scale-110 transition-transform duration-300 select-none">
                NV<span className="text-[#334155] dark:text-slate-400">.</span>
              </span>
            </div>
          </a>
          ...
          <ul className="hidden md:flex items-center gap-8">
            {navLinks.slice(0, -1).map((link) => (
              <li key={link.name}>
                <a
                  href={link.href}
                  className="text-sm text-[#1F2937]/75 dark:text-gray-400 hover:text-[#334155] dark:hover:text-white transition-colors relative group font-medium"
                >
                  {link.name}
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#334155] group-hover:w-full transition-all duration-300"></span>
                </a>
              </li>
            ))}
            ...
            <li>
              <a
                href="#contact"
                className="px-5 py-2.5 bg-[#334155] hover:bg-[#1E293B] text-white text-sm font-medium rounded-lg transition-all duration-300 shadow-sm"
              >
                Me contacter
              </a>
            </li>
      ...
      >
        {/* Menu Header */}
        <div className="flex items-center justify-between p-4 border-b border-[#E5E7EB] dark:border-gray-800">
            ...
            {navLinks.map((link, index) => (
              <li key={link.name}>
                <a
                  href={link.href}
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="flex items-center gap-3 px-4 py-3 rounded-xl text-[#1F2937] dark:text-gray-300 hover:bg-[#F1F5F9] dark:hover:bg-gray-800 transition-all duration-200"
                  style={{
        ...
        {/* Menu Footer */}
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-[#E5E7EB] dark:border-gray-800">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="flex-1 py-2 bg-[#F7F7F8] dark:bg-gray-800 border border-[#E5E7EB] dark:border-gray-700 rounded-lg flex items-center justify-center gap-2 text-[#475569] dark:text-gray-400 hover:text-[#334155] dark:hover:text-white hover:bg-[#F1F5F9] dark:hover:bg-gray-700 transition-colors"
            >
