    ...
    >
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4 md:hidden">
          ...
          <button
            onClick={toggleTheme}
            className="w-10 h-10 rounded-xl bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 flex items-center justify-center transition-all duration-300"
            aria-label="Toggle theme"
          >
            {theme === "dark" ? (
              <svg
          ...
          <button
            ...
            className="w-10 h-10 flex flex-col items-center justify-center gap-1.5 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors"
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden absolute top-full left-0 right-0 bg-white/95 dark:bg-gray-950/95 backdrop-blur-lg border-b border-gray-200 dark:border-gray-800/50 transition-all duration-300 overflow-hidden ${
