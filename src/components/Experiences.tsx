        ...
        <div className="relative max-w-5xl mx-auto py-8">
              ...
              >
                ...
                <ul className="space-y-3">
                  {item.details.map((detail, idx) => (
                    <li
                      key={idx}
                      className="text-gray-600 dark:text-gray-400 text-sm flex items-start leading-relaxed"
                    >
          ...
          <div className="relative mt-16 flex justify-center md:justify-center">
            ...
            >
              ...
              <div className="mt-3 px-4 py-2 bg-white dark:bg-gray-900/80 rounded-xl border border-gray-200 dark:border-blue-500/30 backdrop-blur-sm">
